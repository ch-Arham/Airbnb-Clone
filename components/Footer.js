const Footer = () => {
  return (
    <section>
      <div className="grid grid-cols-1 md:grid-cols-4 gap-y-10 px-32 py-8 bg-gray-100 text-gray-600">
        <div className="space-y-4 text-xs text-gray-800">
          <h5 className="font-bold">ABOUT</h5>
          <p>How Airbib Works</p>
          <p>Newsroom</p>
          <p>Investors</p>
          <p>Airbnb Plus</p>
          <p>Airbnb Luxe</p>
      ...
      <div className="py-4 bg-gray-200 relative">
        <div className="flex justify-center">
          <p className="mr-9 text-gray-800 cursor-pointer">
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fab"
